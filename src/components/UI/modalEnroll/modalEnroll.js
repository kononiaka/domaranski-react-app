...
const ModalEnroll = (props) => {
    ...
    const confirmHandler = (event) => {
        ...
        console.log('logged', emailValue);
        console.log('logged', firstNameValue);
        console.log('logged', lastNameValue);
        console.log('logged', countryNameValue);
    };
    ...
    return (
        <Modal onClick={props.onClose} onSubmit={props.submit} onEnroll={props.enroll}>
            <div className={classes.generic_head_price}>
                <h3>Your Payment</h3>
            </div>
            <div className={classes.total_payment}>
                <h3>rate: <span className={classes.span}>$999/year</span></h3>
            </div>
            ...
            >
                <div className={isDesktopOrLaptop ? classes.form_group : classes.form_group_responsive}>
                    <div className={isDesktopOrLaptop ? classes.form_control : classes.form_control_responsive}>
                        ...
                        <input name="email" type="email" className={"form-control"} placeholder="Email" data-vv-id="1" aria-required="true" aria-invalid="true"></input>
                    </div>
                    <div className={isDesktopOrLaptop ? classes.form_control : classes.form_control_responsive}>
                        <label htmlFor="First Name">First Name</label>
                        <input name="first_name" type="text" className="form-control" placeholder="First Name" data-vv-id="1" aria-required="true" aria-invalid="false"></input>
                    </div>
                    <div className={isDesktopOrLaptop ? classes.form_control : classes.form_control_responsive}>
                        <label htmlFor="Last Name">Last Name</label>
                        <input name="last_name" type="text" className="form-control" placeholder="Last Name" data-vv-id="1" aria-required="true" aria-invalid="false"></input>
                    </div>
                    <div className={isDesktopOrLaptop ? classes.form_control : classes.form_control_responsive}>
                    ...
                    {showPayPalBlock && <div className={classes.paypal_block}>
                        <ul style={{ listStyle: 'none', marginTop: "20px", fontSize: "14px", marginBottom: '-10px' }}>
                            <li>
                                <label>
                            ...
                            <li>
                                <label>
                                    ...
                                    <span className={classes.span_disc}>$100 discount applied</span>
                                </label>
                            </li>
                        </ul>
                    </div>}
                ...
                <div className={classes.button_block}>
                    <button type="submit" className={isDesktopOrLaptop ? classes.submitBtn : classes.submitBtn_responsive}>Start My Free Trial</button>
                    <div className={isDesktopOrLaptop ? classes.btn_subscribe : classes.btn_subscribe_responsive}>
                        or <a href="#" onClick={props.click}>Subscribe Now</a>
                    </div>
                </div>
            </form>
        </Modal>
